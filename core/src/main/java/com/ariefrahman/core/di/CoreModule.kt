...
import com.ariefrahman.core.data.MovieRepository
import com.ariefrahman.core.data.source.local.LocalDataSource
import com.ariefrahman.core.data.source.local.room.MovieDatabase
import com.ariefrahman.core.data.source.remote.ApiService
...
val databaseModule = module {
    ...
    single {
        val passphrase: ByteArray = SQLiteDatabase.getBytes("movieId".toCharArray())
